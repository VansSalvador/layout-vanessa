...
def getApiCredentials():
    ...
    return company.api_key, company.api_secret
...
def adduser():
    ...
    newuser = User(username=flask.request.json['mail'], role=flask.request.json['role'],
                   active=flask.request.json['active'] == 'active', fullname=flask.request.json['name'])
